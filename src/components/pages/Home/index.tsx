    ...
    <main>
      <div className="container mx-auto px-4 my-4 lg:my-10 xl:px-0">
        <div className="flex justify-between items-center">
          <h1 className="text-gray-800 text-xl montserrat font-bold md:text-2xl">Earnings Overview</h1>
        ...
        <div className="flex flex-wrap gap-8 my-8">
          <div className="p-6 bg-white rounded-lg shadow-md w-full overflow-hidden hover:shadow-lg transition-shadow md:w-80">
            ...
            <span className="text-xs text-gray-700">+17.1% from last month</span>
          </div>
          <div className="p-6 bg-white rounded-lg shadow-md w-full overflow-hidden hover:shadow-lg transition-shadow md:w-80">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md w-full overflow-hidden hover:shadow-lg transition-shadow md:w-80">
            ...
            <span className="text-xs text-gray-700">+10.1% from last month</span>
          </div>
          <div className="p-6 bg-white rounded-lg shadow-md w-full overflow-hidden hover:shadow-lg transition-shadow md:w-80">
            <p className="font-medium">Total Cashback</p>
            <p className="mt-10 text-2xl text-gray-800 font-bold">₦43,000</p>
            <span className="text-xs text-gray-700">+20.1% from last month</span>
          </div>
        </div>
      </div>
    </main>
